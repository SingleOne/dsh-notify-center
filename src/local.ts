...
function toastTag(id: string): string {
...
function runCommand(command: LocalCommand, signal: AbortSignal): Promise<void> {
...
export async function sendLocalNotification(
  ...
  if (!command) throw new Error(`local notifications are not supported on ${platform}`)
